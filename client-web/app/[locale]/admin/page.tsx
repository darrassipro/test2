...
import { useGetDashboardQuery } from '@/lib/api/adminApi';
...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: (dashboardData.stats.totalCommunities || dashboardData.stats.activeCommunities).toLocaleString(),
      change: dashboardData.stats.communityGrowth,
      icon: TrendingUp,
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      {dashboardData.recentUsers && dashboardData.recentUsers.length > 0 && dashboardData.recentPosts && dashboardData.recentPosts.length > 0 && (
